...
export const DEFAULT_MENU: Record<string, MenuItem[]> = {
  ...
  bebidas: [
    ...
    { id: 'b3', name: 'Refresco 1.5 L', price: 185, desc: 'Coca-Cola, Sprite, Fanta, Pomelo 1.5 Litros' },
    ...
    { id: 'b7_mil', name: 'Cerveza Miller 1L', price: 290, desc: 'Botella 1 Litro' },
    { id: 'b7_ste', name: 'Cerveza Stella Artois 1L', price: 290, desc: 'Botella 1 Litro' },
    { id: 'b7_cor', name: 'Cerveza Corona 330', price: 190, desc: 'Botella 330ml' },
    { id: 'b7_art', name: 'Cerveza Artesanal', price: 220, desc: 'Cerveza artesanal tirada/lata' },
    ...
    { id: 'b10_sf6', name: 'Salus Frutté 600 ml', price: 95, desc: 'Agua saborizada 600ml' },
    { id: 'b11_sf15', name: 'Salus Frutté 1.5 L', price: 140, desc: 'Agua saborizada 1.5 Litros' },
    { id: 'b12_w', name: 'Whisky', price: 250, desc: 'Medida de Whisky' },
    { id: 'b13_v', name: 'Vino Rosé / Tinto', price: 280, desc: 'Vino de la casa' }
  ],
  extras: [
